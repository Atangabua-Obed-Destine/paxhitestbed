				...
				<div class="row align-items-center text-center">
					<div class="col-md-12">
						<div class="card-body">
							...
							<form method="POST" action="{{ route('student.2fa.verify.submit') }}">
								@csrf
							...
							<div class="text-center">
								...
								<form method="POST" action="{{ route('student.2fa.resend') }}" class="d-inline">
									@csrf
							...
							<a href="{{ route('student.login') }}" class="btn btn-secondary">

                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="event_title" class="form-label">Event Title <span>*</span></label>
                                <input type="text" class="form-control" name="event_title" id="event_title" value="{{ old('event_title') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="event_date" id="event_date" value="{{ old('event_date') }}" required>

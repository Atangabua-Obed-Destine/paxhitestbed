                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_catholic" id="is_catholic-{{ $row->id }}" value="1" {{ $row->is_catholic ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_catholic-{{ $row->id }}">
                                {{ __('Is Catholic') }}
                            </label>
                        </div>

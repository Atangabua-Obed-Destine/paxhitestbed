            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="icon" id="icon-{{ $row->id }}" value="{{ $row->icon }}" placeholder="fas fa-book">
                        <small class="form-text text-muted">FontAwesome icon class (e.g., fas fa-book)</small>
                    </div>

                    <div class="form-group">
                        <label for="contact_info-{{ $row->id }}" class="form-label">Contact Info</label>
                        <textarea class="form-control" name="contact_info" id="contact_info-{{ $row->id }}" rows="3">{{ $row->contact_info }}</textarea>
                        <small class="form-text text-muted">Phone, email, location, or hours</small>
                    </div>

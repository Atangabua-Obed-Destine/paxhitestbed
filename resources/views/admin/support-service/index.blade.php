                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="icon" id="icon" value="{{ old('icon') }}" placeholder="fas fa-book">
                                <small class="form-text text-muted">FontAwesome icon class (e.g., fas fa-book)</small>
                            </div>

                            <div class="form-group">
                                <label for="contact_info" class="form-label">Contact Info</label>
                                <textarea class="form-control" name="contact_info" id="contact_info" rows="3">{{ old('contact_info') }}</textarea>
                                ...
                                <tbody>
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->icon)
                                            <i class="{{ $row->icon }} fa-2x text-primary"></i>
                                            @else
                                        ...
                                        <td>
                                            @if($row->contact_info)
                                            <small>{{ Str::limit($row->contact_info, 50) }}</small>
                                            @else
                                            -
                                            @endif
                                        </td>

...
@section('title', __('withdraw_money'))
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('withdraw_money') }}: {{ $payment_account->title }}</h3>
                    ...
                    <!-- /.card-header -->
                    <form action="{{ route('admin.payment-account.withdraw', $payment_account->id) }}" 
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning">
                                ...
                                <hr>
                                <small><i class="fas fa-info-circle"></i> {{ __('withdraw_info_text') }}</small>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" 
                                               ...
                                               max="{{ $payment_account->current_balance }}" required>
                                        @error('amount')
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-minus-circle"></i> {{ __('make_withdrawal') }}
                            </button>
                        </div>
                    </form>
                </div>

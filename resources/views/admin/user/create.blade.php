                    ...
                    @csrf
                        ...
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <small class="form-text text-muted">{{ __('Auto-generated ID. You can change it manually if needed.') }}</small>
                            ...
                            <fieldset class="row scheduler-border">
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle"></i> Add multiple bank accounts for this staff member. These will be available for selection during payroll payment.
                                    </div>
...
@section('page_js')
    ...
    (function ($) {
        ...
        // Generate Staff ID on page load
        $(document).ready(function() {
            ...
            if (!$staffId.val()) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('admin.user.generate-id') }}",
                    data: {
                        _token: $('input[name=_token]').val()
                    },
                    success: function(response) {
                        console.log('Generated Staff ID:', response.staff_id);
                        $staffId.val(response.staff_id);
                    },
                    error: function(xhr) {
                        console.error('Error generating staff ID:', xhr.responseJSON);
                    }
                });
            }
        });
        ...
        var accountIndex = 1; // Starting from 1 since 0 is the first account
        ...
        $('#add-account').click(function() {
            ...
            // Show remove button on first account if more than one account exists

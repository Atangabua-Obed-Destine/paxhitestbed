...
$(document).ready(function() {
    ...
    $('#program-filter').on('change', function() {
        ...
        if (selectedProgram) {
            $('.course-card').each(function() {
                if ($(this).data('program') == selectedProgram) {
                    $(this).show();
                } else {
                    $(this).hide();
                }
    ...
    $(document).on('click', '.btn-view-schedule', function() {
        var card = $(this).closest('.course-card, tr');
        var semesterId = card.find('.course-semester-select').val();
        var sectionId = card.find('.course-section-select').val();
        var examTypeId = card.find('.course-exam-type-select').val();
        ...
        // Navigate directly to the exam routine page with the selected parameters
        var url = "{{ route('admin.exam-routine.index') }}?semester=" + semesterId + 
                  "&section=" + sectionId + 
                  "&type=" + examTypeId;
    ...
    if (myCoursesCollapse) {
        // My Assigned Courses is collapsed by default

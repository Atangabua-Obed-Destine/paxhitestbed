                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ $row->hostelRoom->room->name ?? '' }} ({{ $row->hostelRoom->room->roomType->title ?? '' }})
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <strong style="color: #667eea;">#{{ $row->studentEnrolls->sortByDesc('id')->first()->matricule ?? $row->student_id }}</strong>
                                            </a>
                                            @endisset
                                        </td>

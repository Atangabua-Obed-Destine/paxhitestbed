    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5><i class="fas fa-edit"></i> {{ __('Edit Dynamic Popup') }}</h5>
                    </div>
                    <div class="card-block">
                        <form action="{{ route($route.'.update', $row->id) }}" method="POST" enctype="multipart/form-data" id="popupForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                           id="title" name="title" value="{{ old('title', $row->title) }}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control @error('summary') is-invalid @enderror" 
                                              ...
                                              maxlength="500">{{ old('summary', $row->summary) }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="form-check mt-1">
                                            ...
                                            <label class="form-check-label text-danger" for="remove_image">
                                                <small>{{ __('Remove current image') }}</small>
                                            </label>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="image">{{ __('Choose new file') }}</label>
                                    </div>
                                    <small class="form-text text-muted">{{ __('Recommended: 512px × 280px. Max 2MB. Leave empty to keep current.') }}</small>
                                    @error('image')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('button_text') is-invalid @enderror" 
                                           id="button_text" name="button_text" value="{{ old('button_text', $row->button_text) }}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="url" class="form-control @error('link') is-invalid @enderror" 
                                           id="link" name="link" value="{{ old('link', $row->link) }}" 
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('button_color') is-invalid @enderror" 
                                               ...
                                               value="{{ old('button_color', $row->button_color) }}" required>
                                        <div class="input-group-append">
                                            <input type="color" id="colorPicker" class="form-control" 
                                                   value="{{ old('button_color', $row->button_color) }}" 
                                ...
                                <div class="col-md-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="button_text_color" 
                                               id="textLight" value="light" 
                                               {{ old('button_text_color', $row->button_text_color) == 'light' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="button_text_color" 
                                               id="textDark" value="dark" 
                                               {{ old('button_text_color', $row->button_text_color) == 'dark' ? 'checked' : '' }}>
                            ...
                            @php
                                $currentAreas = old('target_areas', $row->target_areas ?? []);
                            @endphp
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input target-area-checkbox" type="checkbox" 
                                               ...
                                               id="area_{{ $key }}"
                                               {{ in_array($key, $currentAreas) ? 'checked' : '' }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control @error('display_frequency') is-invalid @enderror" 
                                        ...
                                        <option value="{{ $key }}" {{ old('display_frequency', $row->display_frequency) == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control @error('popup_position') is-invalid @enderror" 
                                        ...
                                        <option value="{{ $key }}" {{ old('popup_position', $row->popup_position) == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="datetime-local" class="form-control @error('start_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('start_date', $row->start_date ? $row->start_date->format('Y-m-d\TH:i') : '') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="datetime-local" class="form-control @error('end_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('end_date', $row->end_date ? $row->end_date->format('Y-m-d\TH:i') : '') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control @error('priority') is-invalid @enderror" 
                                           id="priority" name="priority" value="{{ old('priority', $row->priority) }}" 
                                ...
                                <div class="col-md-9">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_dismissible" 
                                               id="is_dismissible" value="1" 
                                               {{ old('is_dismissible', $row->is_dismissible) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="is_pinned" 
                                               ...
                                               {{ old('is_pinned', $row->is_pinned) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_pinned">
                                            <i class="fas fa-thumbtack"></i> {{ __('Pin this popup (always show first)') }}
                                        </label>
                                    </div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="status" 
                                               id="status" value="1" 
                                               {{ old('status', $row->status) ? 'checked' : '' }}>
                            ...
                            <div class="form-group row mt-4">
                                <div class="col-md-9 offset-md-3">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> {{ __('Update Popup') }}
                                    </button>
            ...
            <div class="col-md-4">
                        ...
                        <div id="livePreview" class="bg-light" style="min-height: 300px;">
                            ...
                            <div class="dynamic-popup-preview">
                                <div class="popup-image-preview" style="height: 140px; background: #ddd; display: flex; align-items: center; justify-content: center;">
                                    @if($row->image)
                                    <img src="{{ $row->image_url }}" class="w-100" style="height: 140px; object-fit: cover;">
                                    @else
                                    <i class="fas fa-image fa-3x text-muted"></i>
                                    @endif
                                </div>
                                <div class="p-3">
                                    <h5 class="popup-title-preview">{{ $row->title }}</h5>
                                    <p class="popup-summary-preview text-muted small mb-3">{{ $row->summary ?: __('No summary provided') }}</p>
                                    @if($row->button_text)
                                    <button class="btn btn-sm popup-button-preview" 
                                            style="background-color: {{ $row->button_color }}; color: {{ $row->button_text_color == 'light' ? '#fff' : '#000' }};">
                                        {{ $row->button_text }} <i class="fas fa-arrow-right ml-1"></i>
                                    </button>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="mb-0"><i class="fas fa-info-circle"></i> {{ __('Popup Information') }}</h6>
                    </div>
                    <div class="card-block">
...
$(document).ready(function() {
    ...
    $('.custom-file-input').on('change', function() {
        ...
        $(this).next('.custom-file-label').html(fileName || '{{ __("Choose new file") }}');
    ...
    $('#summary').on('input', function() {
        $('.popup-summary-preview').text($(this).val() || '{{ __("No summary provided") }}');
    });
    ...
    $('#remove_image').change(function() {
        if ($(this).is(':checked')) {
            $('.popup-image-preview').html('<i class="fas fa-image fa-3x text-muted"></i>');
        } else {
            @if($row->image)
            $('.popup-image-preview').html('<img src="{{ $row->image_url }}" class="w-100" style="height: 140px; object-fit: cover;">');
            @endif
        }
    });
});

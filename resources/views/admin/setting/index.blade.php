            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="staff_attendance_min_hours">Staff Attendance Min Hours</label>
                            <input type="number" step="0.01" class="form-control" name="staff_attendance_min_hours" id="staff_attendance_min_hours" value="{{ isset($row->staff_attendance_min_hours)?$row->staff_attendance_min_hours:'8.00' }}">
                        </div>

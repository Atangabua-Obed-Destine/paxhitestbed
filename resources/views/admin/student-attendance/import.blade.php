                        ...
                        @csrf
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="downloadTemplate()"><i class="fas fa-download"></i> {{ __('Download List') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    function downloadTemplate() {
        ...
        if(session == '' || subject == '') {
            alert('{{ __("Please select Session and Subject") }}');
            return;
        }
        
        var url = "{{ route('admin.student-attendance.download-template') }}" + "?session=" + session + "&subject=" + subject;

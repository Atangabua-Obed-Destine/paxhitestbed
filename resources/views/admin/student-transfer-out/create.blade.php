                            ...
                            <div class="row gx-2">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control select2" name="student" id="student" required>
                                        ...
                                        <option value="{{ $student->student_id }}" @if($selected_student == $student->student_id) selected @endif>{{ $student->currentEnroll->matricule ?? $student->student_id }} - {{ $student->first_name }} {{ $student->last_name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset class="row gx-2 scheduler-border">
                                    ...
                                    @php
                                        // Get latest enrollment for transfer display

                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="is_catholic_baptised" name="is_catholic_baptised" {{ $row->is_catholic_baptised ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="is_confirmed" name="is_confirmed" {{ $row->is_confirmed ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="has_first_communion" name="has_first_communion" {{ $row->has_first_communion ? 'checked' : '' }}>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="present_province" id="present_province" value="{{ $row->present_province }}">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="present_district" id="present_district" value="{{ $row->present_district }}">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="permanent_province" id="permanent_province" value="{{ $row->permanent_province }}">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="permanent_district" id="permanent_district" value="{{ $row->permanent_district }}">

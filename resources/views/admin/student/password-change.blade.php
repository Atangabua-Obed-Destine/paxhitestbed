    <!-- Edit modal content -->
    @php
        // Support both $row (from show view) and $student (from index view)
        $studentForModal = isset($student) ? $student : $row;
    @endphp
    <div id="changePasswordModal-{{ $studentForModal->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              <form class="needs-validation" novalidate action="{{ route($route.'-password-change') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <!-- Form Start -->
                    <input type="hidden" name="student_id" value="{{ $studentForModal->id }}">

...
<head>
    ...
    <style>
        ...
        .admin-toolbar .btn-download:hover {
...
<body>
    ...
    <div class="admin-toolbar no-print">
        <span class="toolbar-title">
            ...
            Form A3 Preview - {{ $student->first_name }} {{ $student->last_name }}
        </span>
        <div class="toolbar-actions">
            ...
            <a href="{{ route('admin.student-form-a3.download', $record->id) }}" class="btn btn-download">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">

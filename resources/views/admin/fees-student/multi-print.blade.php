                ...
                <td class="temp-footer">
                  <div class="inner">
                    ...
                    <div style="text-align: center; margin-top: 15px;">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?data={{ urlencode(url('verify-receipt/'.$row->id)) }}&size=120x120&margin=5" 
                             alt="QR Code" 
                             style="width: 120px; height: 120px; border: 2px solid #333; padding: 5px; background: white;">

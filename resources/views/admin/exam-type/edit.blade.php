              ...
              <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" name="is_final" id="is_final-{{ $row->id }}" value="1" @checked(old('is_final', $row->is_final))>
                        <label class="form-check-label" for="is_final-{{ $row->id }}">{{ __('field_final_exam') }}</label>
                    </div>

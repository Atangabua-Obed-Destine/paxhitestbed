                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="student" id="student" required>
                                    ...
                                    <option value="{{ $student->id }}" @if(old('student') == $student->id) selected @endif>{{ $student->studentEnrolls->sortByDesc('id')->first()->matricule ?? $student->student_id }} - {{ $student->first_name }} {{ $student->last_name }}</option>
                                    @endforeach
                                </select>
                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            #{{ $row->noteable->studentEnrolls->sortByDesc('id')->first()->matricule ?? $row->noteable->student_id ?? '' }}
                                            </a>
                                            @endisset
                                        </td>

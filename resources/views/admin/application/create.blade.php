...
<div class="main-body">
    <div class="page-wrapper">
        ...
        <div class="alert alert-info d-flex justify-content-between align-items-center">
          <div>
            <strong>{{ __('Already started?') }}</strong> {{ __('Sign in to continue your saved application and monitor progress.') }}
          </div>
          <a href="{{ route('application.login') }}" class="btn btn-outline-primary btn-sm">{{ __('Access portal') }}</a>
        </div>
                    ...
                    @csrf
                        ...
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="invalid-feedback">
                                  {{ __('required_field') }} {{ __('Confirm password') }}
                                </div>
                            </div>
              ...
              <div class="form-group col-12 mt-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="agree_terms">
                    {{ __('I confirm that the information provided is accurate and authorise the institution to contact me regarding my application.') }}
                  </label>
                </div>
              </div>

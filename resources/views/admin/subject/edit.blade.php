                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="credit_hour" id="credit_hour" value="{{ $row->credit_hour }}" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="subject_type" id="subject_type" required>
                                ...
                                <option value="2" @if( $row->subject_type == 2 ) selected @endif>{{ __('subject_type_university_requirement') }}</option>
                            </select>

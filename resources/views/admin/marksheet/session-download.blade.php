    ...
    <table class="table-no-border top-meta-table">
        <tbody>
            <tr>
                ...
                <td class="meta-data width2">: {{ $session_data->matricule ?? $row->student_id }}</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if(isset($item->subjectMarks))
                    @foreach($item->subjectMarks as $mark)
                        @if($mark->subject_id == $subject->id && $mark->is_visible_to_student)
                        @php
                        ...
                        if(!$isPublishTimeReached) continue;
                        $marks_per = round($mark->total_marks);
                        @endphp

...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('Receivables Aging Report') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Receivables Aging') }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.accounting-reports.receivables-aging') }}">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Aging Details by Customer') }}</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">{{ __('No receivables data found') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                        @if(isset($report['summary']))
...
function exportToExcel() {
    window.location.href = "{{ route('admin.accounting-reports.export-excel') }}?report=receivables-aging&as_of_date={{ $asOfDate }}";
}

function exportToPdf() {
    window.location.href = "{{ route('admin.accounting-reports.export-pdf') }}?report=receivables-aging&as_of_date={{ $asOfDate }}";
}
</script>
@endsection

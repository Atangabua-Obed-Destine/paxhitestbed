...
@section('title', __('Student Fee Aging Report'))
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('Student Fee Aging Report') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Student Fee Aging') }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-outline card-danger">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.accounting-reports.student-fee-aging') }}">
                        <div class="row">
                            <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['current'] ?? 0) }}</h4>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['days_31_60'] ?? 0) }}</h4>
                            <p>{{ __('31-60 Days') }}</p>
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['days_61_90'] ?? 0) }}</h4>
                            <p>{{ __('61-90 Days') }}</p>
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-orange">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['days_91_120'] ?? 0) }}</h4>
                            <p>{{ __('91-120 Days') }}</p>
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['over_120'] ?? 0) }}</h4>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="small-box bg-secondary">
                        <div class="inner">
                            <h4>{{ number_format($report['summary']['total'] ?? 0) }}</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Student Fee Aging Details') }}</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('admin.student.show', $item['student_id'] ?? 0) }}">{{ $item['student_code'] }}</a></td>
                            ...
                            @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted">{{ __('No student fee aging data found') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                        @if(isset($report['summary']))
...
function exportToExcel() {
    window.location.href = "{{ route('admin.accounting-reports.export-excel') }}?report=student-fee-aging&as_of_date={{ $asOfDate }}&program_id={{ request('program_id') }}&batch_id={{ request('batch_id') }}";
}

function exportToPdf() {
    window.location.href = "{{ route('admin.accounting-reports.export-pdf') }}?report=student-fee-aging&as_of_date={{ $asOfDate }}&program_id={{ request('program_id') }}&batch_id={{ request('batch_id') }}";
}
</script>
@endsection

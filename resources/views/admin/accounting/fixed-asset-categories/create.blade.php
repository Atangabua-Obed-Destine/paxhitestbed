...
@section('title', __('add_asset_category'))
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('add_asset_category') }}</h3>
                    ...
                    <form action="{{ route('admin.fixed-asset-categories.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('depreciation_method') is-invalid @enderror" 
                                            ...
                                            <option value="straight_line" {{ old('depreciation_method', 'straight_line') == 'straight_line' ? 'selected' : '' }}>{{ __('straight_line') }}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('default_useful_life') is-invalid @enderror" 
                                               id="default_useful_life" name="default_useful_life" value="{{ old('default_useful_life', 5) }}" required min="1" max="100">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">{{ __('class_2_accounts') }}</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">{{ __('class_28_accounts') }}</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">{{ __('class_68_accounts') }}</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('disposal_account_id') is-invalid @enderror" 
                                            ...
                                            <option value="">{{ __('select_account') }}</option>
                                            @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ old('disposal_account_id') == $account->id ? 'selected' : '' }}>
                                                {{ $account->account_code }} - {{ $account->account_name }}
                                            </option>
                                            @endforeach
                                        </select>

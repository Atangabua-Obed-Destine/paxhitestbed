{{--
    ================================================================
    ADMISSIONS — {{ institution_name() }}
    ================================================================
--}}
@extends('web2.layouts.master')

@section('title', 'Admissions — ' . (institution_code()))
@section('description', 'Begin your journey at ' . institution_name() . '. Find admission requirements, key dates, downloadable forms, and answers to frequently asked questions.')
